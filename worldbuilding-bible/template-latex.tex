...
$else$
% LIGHT MODE - white pages, black text
...
\definecolor{quotetint}{HTML}{EDE8F0}
\definecolor{linkcolor}{HTML}{888888}
$endif$
...
\renewcommand{\maketitle}{%
  ...
  % True black background using TikZ overlay (always black regardless of mode)
