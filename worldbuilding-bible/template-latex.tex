...
$if(dark-mode)$
% DARK MODE - black pages, white text
...
% H1 - Heading font 24pt (cleaner, less imposing)
\titleformat{\section}
  {\headingfont\fontsize{24pt}{28pt}\selectfont\color{textcolor}}
  {}{0em}{}
...
% H2 - Heading font 14pt with flexible spacing
\titleformat{\subsection}
  {\headingfont\fontsize{14pt}{17pt}\selectfont\color{textcolor}}
  {}{0em}{}
\titlespacing*{\subsection}{0pt}{4mm plus 1mm minus 0.5mm}{1.5mm}

% H3 - Bold 11pt with flexible spacing
\titleformat{\subsubsection}
  {\bfseries\fontsize{11pt}{13pt}\selectfont\color{textcolor}}
  {}{0em}{}
...
\usepackage{caption}
\captionsetup{font={scriptsize}, labelfont={bf}, format=plain, skip=0.5mm, justification=raggedright, singlelinecheck=false}
...
% NO minipage - allows newspaper-style flow across columns
% Usage: \colfig{image path}{text caption}{list caption with attribution}
\newcommand{\colfig}[3]{%
  \par\vspace{0.5mm}\noindent%
  \centering%
  \includegraphics[width=0.92\columnwidth,keepaspectratio,max height=0.24\textheight]{#1}%
  \par\nopagebreak[4]%
...
\newcommand{\colgridfig}[6]{%
  ...
  \begin{tabular}{@{}c@{\hspace{0.5mm}}c@{}}%
    \includegraphics[width=0.46\columnwidth,keepaspectratio,max height=0.09\textheight]{#1} &
    \includegraphics[width=0.46\columnwidth,keepaspectratio,max height=0.09\textheight]{#2} \\[0.3mm]
    \includegraphics[width=0.46\columnwidth,keepaspectratio,max height=0.09\textheight]{#3} &
    \includegraphics[width=0.46\columnwidth,keepaspectratio,max height=0.09\textheight]{#4}
  \end{tabular}%
  \par\nopagebreak[4]%
...
\newcommand{\colpairfig}[4]{%
  \par\vspace{0.5mm}\noindent%
  \centering%
  \includegraphics[width=0.485\columnwidth,keepaspectratio,max height=0.17\textheight]{#1}%
  \includegraphics[width=0.485\columnwidth,keepaspectratio,max height=0.17\textheight]{#2}%
  \par\nopagebreak[4]%
...
\newcommand{\coltriplefig}[5]{%
  \par\vspace{0.5mm}\noindent%
  \centering%
  \includegraphics[width=0.88\columnwidth,keepaspectratio,max height=0.07\textheight]{#1}%
  \par\nobreak\vspace{0.3mm}%
  \includegraphics[width=0.88\columnwidth,keepaspectratio,max height=0.07\textheight]{#2}%
  \par\nobreak\vspace{0.3mm}%
  \includegraphics[width=0.88\columnwidth,keepaspectratio,max height=0.07\textheight]{#3}%
  \par\nopagebreak[4]%
...
\newcommand{\coldualfig}[4]{%
  \par\vspace{0.5mm}\noindent%
  \centering%
  \includegraphics[width=0.92\columnwidth,keepaspectratio,max height=0.14\textheight]{#1}%
  \par\nobreak\vspace{0.3mm}%
  \includegraphics[width=0.92\columnwidth,keepaspectratio,max height=0.14\textheight]{#2}%
  \par\nopagebreak[4]%
  \captionof{figure}[#4]{#3}%
  \par\vspace{0.5mm}%
  \raggedright%
...
\renewcommand{\maketitle}{%
  ...
  \begin{center}
    ...
    % Subtitle in PT Sans (white on black) - constrained to title width
    $if(subtitle)$
    {\sffamily\bfseries\fontsize{16pt}{20pt}\selectfont\color{white} Worldbuilding Bible\par}
    \vspace{4mm}
    \parbox{\titlewidth}{\centering\sffamily\fontsize{11pt}{15pt}\selectfont\color{white!60} $subtitle$\par}
    \vspace{10mm}
    $endif$

    % Author and date (white on black)
    {\small\color{white} \@author\quad·\quad\@date\par}

    \vspace{10mm}

    % Institution (white on black)
    {\small\color{white} Technische Hochschule Ostwestfalen-Lippe\\[2mm]
