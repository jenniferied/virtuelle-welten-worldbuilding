...
\titleformat{\subsection}
  ...
  {}{0em}{}
\titlespacing*{\subsection}{0pt}{2mm plus 1mm minus 1mm}{0.5mm}

% H3 - Bold 12pt with flexible spacing
\titleformat{\subsubsection}
  {\bfseries\fontsize{12pt}{14pt}\selectfont\color{black}}
  {}{0em}{}[\nopagebreak]
\titlespacing*{\subsubsection}{0pt}{2mm plus 1mm minus 0.5mm}{0.5mm plus 0.25mm}
...
\usepackage{caption}
\captionsetup{font={small}, labelfont={bf}, format=plain, skip=1mm}
\renewcommand{\figurename}{Abb.}

% Reduce spacing around figures
\setlength{\intextsep}{2pt plus 1pt minus 1pt}  % Space above/below floats in text
\setlength{\floatsep}{2pt plus 1pt minus 1pt}   % Space between floats
\setlength{\textfloatsep}{4pt plus 1pt minus 1pt} % Space between float and text
...
% Page-spanning columns: UNBALANCED (fill left column first, then next)
% Use for full-page layouts where you want content to flow top-to-bottom
...
\newcommand{\colfig}[3]{%
  ...
  \begin{minipage}{\columnwidth}%
    \centering%
    \includegraphics[width=\columnwidth,keepaspectratio,max height=0.4\textheight]{#1}%
...
\newcommand{\colgridfig}[6]{%
  ...
  \begin{minipage}{\columnwidth}%
    \centering%
    \begin{tabular}{@{}c@{\hspace{1mm}}c@{}}%
      \includegraphics[width=0.48\columnwidth,max height=0.2\textheight,keepaspectratio]{#1} &
      \includegraphics[width=0.48\columnwidth,max height=0.2\textheight,keepaspectratio]{#2} \\[1mm]
      \includegraphics[width=0.48\columnwidth,max height=0.2\textheight,keepaspectratio]{#3} &
      \includegraphics[width=0.48\columnwidth,max height=0.2\textheight,keepaspectratio]{#4} \\
    \end{tabular}%
...
\newcommand{\colpairfig}[4]{%
  ...
  \begin{minipage}{\columnwidth}%
    \centering%
    \begin{tabular}{@{}c@{\hspace{1mm}}c@{}}%
      \includegraphics[width=0.48\columnwidth,max height=0.25\textheight,keepaspectratio]{#1} &
      \includegraphics[width=0.48\columnwidth,max height=0.25\textheight,keepaspectratio]{#2} \\
    \end{tabular}%
...
\newcommand{\coltriplefig}[5]{%
  ...
  \begin{minipage}{\columnwidth}%
    \centering%
    \includegraphics[width=\columnwidth,max height=0.18\textheight,keepaspectratio]{#1}\\[1mm]
    \includegraphics[width=\columnwidth,max height=0.18\textheight,keepaspectratio]{#2}\\[1mm]
    \includegraphics[width=\columnwidth,max height=0.18\textheight,keepaspectratio]{#3}%
...
\newcommand{\coldualfig}[4]{%
  ...
  \begin{minipage}{\columnwidth}%
    ...
    \includegraphics[width=\columnwidth,max height=0.22\textheight,keepaspectratio]{#2}%
    \captionof{figure}[#4]{#3}%
  \end{minipage}%
  \par\vspace{2mm}%
}
...
\renewcommand{\maketitle}{%
  ...
  \begin{center}
    % Title in Molot - plain black, industrial Soviet look
    {\titlefont\fontsize{90pt}{100pt}\selectfont\@title\par}

    \vspace{15mm}

    % Subtitle in PT Mono (plain background)
    $if(subtitle)$
    \begin{tcolorbox}[enhanced, frame hidden,
      colback=pagewhite,
      ...
      width=0.85\textwidth]
      \centering
      {\subtitlefont\bfseries\fontsize{16pt}{20pt}\selectfont\color{black} Worldbuilding Bible\par}
      \vspace{4mm}
      {\subtitlefont\fontsize{11pt}{15pt}\selectfont\color{black!70} $subtitle$\par}
    \end{tcolorbox}
    \vspace{10mm}
    $endif$
  ...
  % Logos at bottom right using TikZ overlay (doesn't affect text centering)
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south east, inner sep=0pt] at ([xshift=-15mm, yshift=15mm]current page.south east) {%
      ...
      \hspace{5mm}%
      \includegraphics[height=20mm]{../../assets/logos/mp-logo.png}%
    };
  \end{tikzpicture}
