...
% Heading font: Futura Bold (system font, clean geometric)
...
% Page break before each section (chapter)
...
\renewcommand{\maketitle}{%
  ...
  \begin{center}
    % Title in Molot 48pt (Soviet constructivist display)
    {\titlefont\fontsize{48pt}{54pt}\selectfont\@title\par}

    \vspace{12mm}

    % Subtitle in Futura Bold
    $if(subtitle)$
    {\headingfont\fontsize{16pt}{20pt}\selectfont $subtitle$\par}
    \vspace{10mm}
    $endif$
    ...
    {\small Technische Hochschule Ostwestfalen-Lippe\\[2mm]
     Fachbereich Medienproduktion\\[2mm]
     Master Medienproduktion\par}
  \end{center}
