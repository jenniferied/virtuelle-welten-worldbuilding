...
% Body: Lora 10pt (variable font from repository)
\setmainfont{Lora}[
  Path = \fontpath,
  UprightFont = {Lora[wght].ttf},
  ItalicFont = {Lora-Italic[wght].ttf},
  BoldFont = {Lora[wght].ttf},
  BoldItalicFont = {Lora-Italic[wght].ttf},
  BoldFeatures = {Weight=700},
  BoldItalicFeatures = {Weight=700}
]

% Sans: Open Sans (variable font from repository)
...
% Heading font: Source Serif 4 Italic (variable font from repository)
% Aria Text G2 is commercial - Source Serif 4 is a similar transitional serif
\newfontfamily\headingfont{SourceSerif4}[
  Path = \fontpath,
  UprightFont = {SourceSerif4[opsz,wght].ttf},
  ItalicFont = {SourceSerif4-Italic[opsz,wght].ttf},
  BoldFont = {SourceSerif4[opsz,wght].ttf},
  BoldItalicFont = {SourceSerif4-Italic[opsz,wght].ttf},
  BoldFeatures = {Weight=700},
  BoldItalicFeatures = {Weight=700}
]

% Title font (same as heading)
...
% ==========================================================================
%   HEADINGS - Source Serif 4 Italic 30pt
% ==========================================================================
...
% H1 - Source Serif 4 Italic 30pt
\titleformat{\section}
  {\headingfont\fontsize{30pt}{36pt}\selectfont\itshape\color{black}}
  {}{0em}{}
...
% H2 - Source Serif 4 Italic 18pt
\titleformat{\subsection}
  {\headingfont\fontsize{18pt}{22pt}\selectfont\itshape\color{black}}
  {}{0em}{}
...
\usepackage{graphicx}
\usepackage{float}
\floatplacement{figure}{H}  % Force figures to stay in place, not float above headings
\usepackage{wrapfig}
...
\renewcommand{\maketitle}{%
  ...
  \begin{center}
    % Title in Source Serif 4 Italic 48pt
    {\titlefont\fontsize{48pt}{54pt}\selectfont\itshape\@title\par}

    \vspace{12mm}

    % Subtitle
    $if(subtitle)$
    {\titlefont\fontsize{16pt}{20pt}\selectfont $subtitle$\par}
    \vspace{10mm}
    $endif$
...
\begin{minipage}[t]{0.33\textwidth}
  \vspace{10mm}
  \fcolorbox{border}{boxbg}{\parbox{0.95\linewidth}{\vspace{80mm}\centering\color{gray}[Cover Art]\vspace{80mm}}}
\end{minipage}
\newpage
$endif$
